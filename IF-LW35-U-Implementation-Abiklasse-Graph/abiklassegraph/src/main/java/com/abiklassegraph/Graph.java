...
public class Graph{
  ...
  //EIGENER CODE
    ...
    while (vertices.hasAccess()){
      returnValue.append(vertices.getContent());
      vertices.next();
    }
    return returnValue;
  }
  ...
  public List<Edge> getEdges(){
    ...
    List<Edge> returnValue = new List<Edge>();
    edges.toFirst();
    while (edges.hasAccess()){
      returnValue.append(edges.getContent());
      edges.next();
    }
    return returnValue;
  }
  ...
  public Vertex getVertex(String pID){
    ...
    while (vertices.hasAccess()) {
      if (vertices.getContent().getID().equals(pID)) {
        returnValue = vertices.getContent();
      }
    }
    return returnValue;
  }
